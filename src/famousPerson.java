...
public class famousPerson implements Serializable {
    ...
    public static void ask() {
        ...
        famous.put(2, Map.of("\nПредприниматель, инженер, основатель копании по производству аэрокосмической техники и оказанию услуг космического транспорта\n", List.of("Илон Маск", "Elon Musk", "Маск", "Илан Маск", "Musk")));
        famous.put(3, Map.of("\nЯпонский геймдизайнер, геймдиректор, сценарист и продюсер\n", List.of("Хидэо Кодзима", "Кодзима", "Хидео Кодзима", "Хидэо Кадзима", "Кадзима", "Хидео Кадзима", "Гений", "Хидэо Котзима", "Котзима", "Хидео Котзима", "Хидэо Катзима", "Катзима", "Хидео Катзима")));
        ...
        jokes.put(1, "Вас не учили использовать защиту? Присмотритесь к его разработке - вещь полезная \nЯ сам без неё даже к перегоревшей микроволновке не полезу\n");
